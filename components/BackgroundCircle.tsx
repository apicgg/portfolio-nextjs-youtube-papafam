...
const BackgroundCircle = (props: Props) => {
  return (
    <motion.div
      ...
      <div className='absolute border border-[#8a8a8a] rounded-full h-[200px] w-[200px] mt-52 animate-ping' />
      ...
      <div className='absolute border rounded-full border-[#333] h-[800px] w-[800px] mt-52' />
    </motion.div>
  )
}
